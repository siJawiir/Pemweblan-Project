...
<body>
    ...
    <div class="container" style="margin-top: 80px">
        <div class="col-md-12">
            ...
            echo form_open(base_url('menu/simpan')) ?>
              ...
              <div class="form-group">
                ...
                <input type="text" name="harga_menu" class="form-control" placeholder="Masukkan harga menu" >
              </div>

              <div class="form-group">
                <label for="text">id jenis</label>
                <input type="text" name="id_jenis" class="form-control" placeholder="Masukkan id jenis">
              </div>
