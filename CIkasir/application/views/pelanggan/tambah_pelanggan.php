...
<body>
    ...
    <div class="container" style="margin-top: 80px">
        <div class="col-md-12">
            ...
            echo form_open(base_url('pelanggan/simpan')) ?>

              <div class="form-group">
                <label for="text">Id Pelanggan</label>
                <input type="int" name="id_pelanggan" class="form-control" placeholder="Masukkan id pelanggan">
              </div>
              ...
              <div class="form-group">
                <label for="text">No HP pelanggan</label>
                <input type="text" name="no_hp" class="form-control" placeholder="Masukkan No HP pelanggan">
              </div>
